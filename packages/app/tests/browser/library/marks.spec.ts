...
// own wire into [[Visit mode]]. The rule behind that one is `src/lib/visit.test.ts`'s, and the
...
/**
 * Press [[Another passage]] and wait for the card to have actually turned over.
 *
