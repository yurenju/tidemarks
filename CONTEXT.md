...
**書架第一屏最上面那張卡，一次顯示一條畫線。** 可以往前往後翻，照建立時間由新到舊，翻到底繞回第一
條。畫線本來只活在閱讀器的〈筆記〉面板裡，而那個面板一次只講一本書——所以在某本書畫過的句子，除非
重新打開那本書，否則不會再出現在眼前。這張卡是為了讓它出現。

卡上有**出處**（封面小圖加上加粗的書名）、**引文**，以及讀者當時寫的想法；沒寫過的顯示一個輸入框邀
他補一句。出處跟書名同一個視覺重量是硬規則：它必須是那一屏上最顯眼的書名，否則句子會被歸給旁邊那本
〈正在讀〉。
...
_Avoid_: 筆記牆／時間軸（那是被否掉的那個形狀）、carousel（英文詞，而且它沒有自動輪播）
...
大書，靠體積跟牆上的封面拉開差距；換成〈輪詢卡〉當主角之後那條路走不通了，而動作這條比尺寸耐用——
...
**一本都沒有的時候那一排就不出現**（全新的書架，或全部讀完），第一屏是〈輪詢卡〉加封面牆。把一本沒
