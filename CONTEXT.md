...
舊的判準是「偶爾去一次的地方」，它分不出〈設定〉與〈書的詳情〉，所以〈設定〉當年被歸成抽屜，
一路長到六項排版設定都住在裡面。換成上面這條就分得開了：設定跟你剛才在書架還是在書裡無關，
所以它是一層樓；書的詳情講的就是底下那本書。這條判準也能預測下一個東西該去哪，那是舊那條做
不到的。
...
_Avoid_: 語言（它答的不是「這本書是什麼語言」，而且會讓人拿去決定字型或介面語系——那是別的判斷）、
簡繁（`detectVariant` 那個，答的是另一個問題）
